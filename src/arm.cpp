...
#include <Eigen/SVD>   // For SVD functionality
...
// Init joint config.
double q_desired[6] = {-0.75, -1.57, 1.57, -0.37, -2.45, -2.45};
double t_init = 3;
// Gains and motion variables
double kp = 15;
...
{
    double t = d->time - t_init; // Reset time for periodic motion init time
...
int main(int argc, const char** argv)
{
    ...
    while( !glfwWindowShouldClose(window))
    {
       ...
       // get framebuffer viewport
        ...
        // cam.lookat[0] = d->qpos[0] ; //Uncomment this to let camera moving
